...
hyperkdata hyperkRead(const std::string & lightcurvePath, const std::string & dataPath, const std::string &option, const double factor) // expects lightcurvePath: the path to the 12solar2 or 15solar2, dataPath: path to the snowglobes output, specifier either 12 or 15 depending on solar masses 
{
