// Draws all histograms. This script works on ROOT 5.
// Author: Mark Schoene.
{
...
gROOT->ProcessLine(".x drawSameEnergyHist.C(&histograms_emitted, color, label_DUNE_normal, ylabel, &pathEI, -2, 5, 50, 56, emitted_legend)");
