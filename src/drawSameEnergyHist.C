void drawSameEnergyHist(std::vector<TH1D *> * histo_ptr, std::vector<Color_t> color, std::vector<std::string> label, std::string ylabel, TString *path, int xLow, int xUp, int yLow, int yUp, double leg[])
{
    vector<TH1D*> &histograms = *histo_ptr;
