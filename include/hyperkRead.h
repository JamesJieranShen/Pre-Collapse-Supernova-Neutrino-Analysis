#ifndef __HYPERKREAD_H_INCLUDED__
#define __HYPERKREAD_H_INCLUDED__
...
hyperkdata hyperkRead(const std::string & lightcurvePath, const std::string & dataPath, const std::string & option, const double factor);
